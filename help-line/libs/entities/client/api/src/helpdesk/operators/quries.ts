...
export const clientOperatorsQueryKeys = {
  root: 'operators',
  view: 'view',
};
...
export const useOperatorsViewQuery = (projectId: string) => {
  ...
  return useQuery(
    [
      projectId,
      clientOperatorsQueryKeys.root,
      clientOperatorsQueryKeys.view,
      'list',
    ],
...
export const useOperatorViewQuery = (operatorId: string) => {
  const operatorApi = useOperatorApi();
  return useQuery(
    [clientOperatorsQueryKeys.root, clientOperatorsQueryKeys.view, operatorId],
...
export const useMyOperatorQuery = () => {
  const operatorApi = useOperatorApi();
  return useQuery([clientOperatorsQueryKeys.root, 'me'], operatorApi.getMe);
};
...
export const useChangeFavoriteMutation = () => {
  ...
  const operatorApi = useOperatorApi();
  return useMutation(
    [clientOperatorsQueryKeys.root, 'favorite', 'change'],
    ...
    {
      onSuccess: (_, params) => {
        client.invalidateQueries([clientOperatorsQueryKeys.root, 'me']);
      },
    }
  );
};
...
export const useOperatorsQuery = () => {
  const operatorApi = useOperatorApi();
  return useQuery([clientOperatorsQueryKeys.root, 'list'], () =>
    operatorApi.getList()
  );
};
...
export const useOperatorQuery = (operatorId: Operator['id']) => {
  const operatorApi = useOperatorApi();
  return useQuery([clientOperatorsQueryKeys.root, operatorId], () =>
...
export const useSetOperatorRoleMutation = (operatorId: Operator['id']) => {
  ...
  const operatorApi = useOperatorApi();
  return useMutation(
    [clientOperatorsQueryKeys.root, operatorId, 'roles', 'set'],
