...
export interface ContextFilterValue extends WithPath, WithType<'ContextFilterValue'> {}
...
export interface ElementMathFilter extends WithPath, WithType<'ElementMathFilter'> {
  itemFilter: Filter;
}
