...
import { TicketCreatedEvent, UserIdType } from "@entities/helpdesk/tickets";
...
import {
  isOperatorInitiator,
  isUserInitiator,
} from "@entities/helpdesk/tickets/utils";
...
export const TicketCreatedEventView: React.FC<
...
> = ({ event }) => {
  return (
    <TicketDiscussionCard
      className={cn(
        css.createView,
        isOperatorInitiator(event.initiator) && css.createdByOperator
      )}
      right={!isUserInitiator(event.initiator)}
    >
