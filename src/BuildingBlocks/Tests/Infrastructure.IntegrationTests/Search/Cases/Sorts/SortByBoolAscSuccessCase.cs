...
{
    public class SortByBoolAscSuccessCase : SortCaseBase
    {
        public override IEnumerable<TestModel> ExpectedResult => Data.OrderBy(x => x.Bool);
        public override IEnumerable<Sort> Sorts => new[] {new Sort(true, nameof(TestModel.Bool))};
    }
}
