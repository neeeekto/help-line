...
- `npx storybook@latest automigrate --config-dir apps/admin/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir apps/main/.storybook --renderer @storybook/react`
